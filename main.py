...
def process_image(image):
    ...
    #vertices = np.array([[(0,imshape[0]), (0.35*imshape[1], 0.45*imshape[0]), (0.65*imshape[1], 0.45*imshape[0]), (imshape[1],imshape[0])]], dtype=np.int32)
    #vertices = np.array([[(0,0.75*imshape[0]), (0.35*imshape[1], 0.45*imshape[0]), (0.65*imshape[1], 0.45*imshape[0]), (imshape[1],0.75*imshape[0])]], dtype=np.int32)
